...
bool step(boost::shared_ptr<Simulator>& s, unsigned INDEX)
{
#ifdef USE_OSG
//  if (ONSCREEN_RENDER)
//  {
...
bool init(int argc, char** argv,boost::shared_ptr<Simulator>& s)
{
